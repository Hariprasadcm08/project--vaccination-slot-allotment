...
const {isValidPhone,isValidString,isValidAge,isValidPincode,isValidAadharNo,isValidPassword,isValidDose,isValidBody,isvalidSlot}=require('../validations/validations')
